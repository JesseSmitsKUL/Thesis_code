...
class Khronos(BaseStream):
    ...
    def calculateMetrics(self):
        ...
        for key in self.constrains:
            ...
            self.meanSquaredError.append(sum(map(lambda x:x*x,self.timeoutDifferences[key][self.indexToEval:]))/len(self.timeoutDifferences[key][self.indexToEval:]))
            self.meanRootSquaredError.append(sqrt(sum(map(lambda x:x*x,self.timeoutDifferences[key][self.indexToEval:]))/len(self.timeoutDifferences[key][self.indexToEval:])))
