...
# file used to tryout improvements=

class MyKhronos(BaseStream):

    def __init__(self,name,times):
        super(MyKhronos, self).__init__(name, times)
        self.alpha = 7.0/8.0
        self.beta = 3.0/4
        self.variance = -1
    ...
    def visualizeData(self):
        ...
        for key in self.constrains:
            plt.plot(self.timeoutDifferences[key][100:400], color='red')
